...
class RegisterView extends GetView<RegisterController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(                          // ✅ ONLY CHANGE
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(
                  () => CommonTextField(
                textFieldController: controller.confirmPasswordController.value,
            ...
            Obx(
                ...
                items: ['worker', 'manager'].map((role) => DropdownMenuItem(
                  value: role,
            ...
            Obx(
                ...
                onTap: controller.isLoading.value ? null : () => controller.validate(),
